...
function addBook(category) {
    ...
    onValue(booksRef, (snapshot) => {
        ...
        for (let index = 0; index < data2.length; index++) {
            ...
            <div class="col-md-6 m-2">
            <div class="card-body">
            <h5 class="card-title fs-5">Title: ${val2.title}</h5>
            <p class="card-text fs-6">Author: ${val2.author}</p>
            <p class="card-text fs-6">Author: ${val2.price}</p>
    ...
    onValue(booksRef, (snapshot) => {
        ...
        for (let index = 0; index < data3.length; index++) {
            ...
            <div class="col-md-6 m-2">
            <div class="card-body">
            <h5 class="card-title fs-5">Title: ${vlu.title}</h5>
            <p class="card-text fs-6">Author: ${vlu.author}</p>
    ...
    onValue(booksRef, (snapshot) => {
        ...
        for (let index = 0; index < data4.length; index++) {
            ...
            <div class="col-md-6 m-2">
            <div class="card-body">
            <h5 class="card-title fs-5">Title: ${vale.title}</h5>
            <p class="card-text fs-6">Author: ${vale.author}</p>
    ...
    onValue(booksRef, (snapshot) => {
        ...
        for (let index = 0; index < data5.length; index++) {
            ...
            <div class="col-md-6 m-2">
            <div class="card-body">
            <h5 class="card-title fs-5">Title: ${valu.title}</h5>
            <p class="card-text fs-6">Author: ${valu.author}</p>
